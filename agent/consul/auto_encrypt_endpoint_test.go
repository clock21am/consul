...
func TestAutoEncryptSign(t *testing.T) {
	...
	tests := []test{
		...
		{Name: "Works with good root", Config: tlsutil.Config{InternalRPC: tlsutil.InternalRPCListenerConfig{ListenerConfig: tlsutil.ListenerConfig{CAFile: root}}}, ConnError: false},
		{Name: "VerifyOutgoing fails because of bad root", Config: tlsutil.Config{InternalRPC: tlsutil.InternalRPCListenerConfig{ListenerConfig: tlsutil.ListenerConfig{CAFile: badRoot}}}, ConnError: true},
		{Name: "VerifyServerHostname fails", Config: tlsutil.Config{InternalRPC: tlsutil.InternalRPCListenerConfig{VerifyServerHostname: true, ListenerConfig: tlsutil.ListenerConfig{CAFile: root}}}, ConnError: false, RPCError: true},
		{Name: "VerifyServerHostname succeeds", Cert: "../../test/key/ourdomain_server.cer", Key: "../../test/key/ourdomain_server.key",
			Config: tlsutil.Config{InternalRPC: tlsutil.InternalRPCListenerConfig{VerifyServerHostname: true, ListenerConfig: tlsutil.ListenerConfig{CAFile: root}}}, ConnError: false, RPCError: false},
	}
