...
type DeprecatedConfig struct {
	...
	// DEPRECATED(TLS) - moved to "tls.internal_rpc.verify_outgoing"
...
func applyDeprecatedTLSConfig(dep DeprecatedConfig, cfg *Config) []string {
	...
	if v := dep.VerifyOutgoing; v != nil {
		if internalRPC.VerifyOutgoing == nil {
			internalRPC.VerifyOutgoing = v
		}
		warns = append(warns, deprecationWarning("verify_outgoing", "tls.internal_rpc.verify_outgoing"))
	}
